...
app.all('/', jsonParser, async (req, res) => {
  ...
  const playButton = { title: 'Давай анекдот', hide: true }
  ...
  const help =
    'Я умею рассказывать анекдоты. Чтобы слушать - просто скажите следующий, некст или любой положительный ответ. Чтобы закрыть - скажите: "Нет", "Выйти" "Закрыть"'
